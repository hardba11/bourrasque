print("*** LOADING instrument_sfd_canvas - sfd_canvas.nas ... ***");

# namespace : instrument_sfd_canvas
...
var SFD_CANVAS = {
    ...
    new: func(placement)
    {
        var m = {
            parents: [SFD_CANVAS],
            canvas: canvas.new(SFD_CANVAS.canvas_settings),
        };
...
var init = setlistener("/sim/signals/fdm-initialized", func() {
    ...
    var sfd_canvas = SFD_CANVAS.new({"node": "sfd_canvas_screen"});
    sfd_canvas.update();
});
