...
# 1
    {
        ...
        'items': [
            ...
            {'list': 'electrical instrument : switch',                'check': 'BAT or EXT'},
            ...
            {'list': 'radio : ADF ',                                  'check': 'ADF'},
            {'list': 'radio : TRANSPONDER',                           'check': 'STBY'},
...
# 2
    {
        ...
        'items': [
            ...
            {'list': 'engine L instrument : cut',                     'check': 'ON'},
            {'list': 'engine L instrument : pump',                    'check': 'ON'},
            {'list': 'engine L instrument : start',                   'check': 'PUSH'},
            {'list': 'engine L started',                              'check': 'WAIT'},
            {'list': 'electrical instrument : switch',                'check': 'ALT'},
            {'list': 'engine R instrument : cut',                     'check': 'ON'},
            {'list': 'engine R instrument : pump',                    'check': 'ON'},
            {'list': 'engine R instrument : start',                   'check': 'PUSH'},
            ...
            {'list': 'engine R started',                              'check': 'WAIT'},
...
# 3
    {
        ...
        'items': [
            ...
            {'list': 'command panel : trim',                          'check': 'CENTER'},
